...
def setup_main_window_ui(main_window):
    ...
    main_window.block_list_widget.setAlternatingRowColors(True)
    ...
    # Add block button
    main_window.add_block_button = QPushButton('+')
    main_window.add_block_button.setToolTip('Add new block (import file)')
    main_window.add_block_button.setFixedSize(32, 32)
    main_window.add_block_button.setEnabled(False)
    block_toolbar.addWidget(main_window.add_block_button)

    # Delete block button
    main_window.delete_block_button = QPushButton('-')
    main_window.delete_block_button.setToolTip('Delete selected block')
    main_window.delete_block_button.setFixedSize(32, 32)
    main_window.delete_block_button.setEnabled(False)
    block_toolbar.addWidget(main_window.delete_block_button)

    # Edit/Rename block button
    main_window.rename_block_button = QPushButton('✎')  # Pencil icon
    main_window.rename_block_button.setToolTip('Rename selected block')
    main_window.rename_block_button.setFixedSize(32, 32)
    main_window.rename_block_button.setEnabled(False)
    block_toolbar.addWidget(main_window.rename_block_button)

    block_toolbar.addStretch()

    # Move up button
    main_window.move_block_up_button = QPushButton('↑')
    main_window.move_block_up_button.setToolTip('Move block up')
    main_window.move_block_up_button.setFixedSize(32, 32)
    main_window.move_block_up_button.setEnabled(False)
    block_toolbar.addWidget(main_window.move_block_up_button)

    # Move down button
    main_window.move_block_down_button = QPushButton('↓')
    main_window.move_block_down_button.setToolTip('Move block down')
    main_window.move_block_down_button.setFixedSize(32, 32)
    main_window.move_block_down_button.setEnabled(False)
    block_toolbar.addWidget(main_window.move_block_down_button)
