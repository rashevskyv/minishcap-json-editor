...
class MainWindow(QMainWindow):
    ...
    def _reconfigure_all_highlighters(self):
        ...
        common_args = {"newline_symbol": self.newline_display_symbol, "newline_css_str": self.newline_css, "tag_css_str": self.tag_css,
                       "show_multiple_spaces_as_dots": self.show_multiple_spaces_as_dots, "space_dot_color_hex": self.space_dot_color_hex}
