...
def setup_main_window_ui(main_window):
    ...
    main_window.preview_text_edit.setObjectName("preview_text_edit") # <--- NAME
    ...
    main_window.original_text_edit.setObjectName("original_text_edit") # <--- NAME
    ...
    main_window.edited_text_edit.setObjectName("edited_text_edit") # <--- NAME
